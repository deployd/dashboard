define(["require", "exports", "module", "../model/property-type-collection","../model/collection-settings","../model/data-collection","./component-type-sidebar-view","./property-list-view","./collection-data-view","./collection-event-view","../app","../router","./undo-button-view"], function(require, exports, module) {
